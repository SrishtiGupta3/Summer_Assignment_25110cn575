...
int main()
{
    ...
    for (i = 0; i < num; i++)
    {
        ...
        printf("Enter bonus: ");
        scanf("%f", &E1[i].bonus);
        printf("Enter TaxDeduction: ");
        scanf("%f", &E1[i].taxDeduction);
        E1[i].grossSalary = E1[i].basicSalary + E1[i].HRA + E1[i].DA + E1[i].bonus;
        E1[i].netSalary = E1[i].grossSalary - E1[i].taxDeduction;
    }
    while (1)
    {
